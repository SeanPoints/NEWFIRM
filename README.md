...
If one has placed NEWFIRM in one's home directory, the following should be added to one's .bashrc or .zshrc

export NEWFIRM=$HOME/newfirm
PATH=$PATH:$NEWFIRM
PYTHONPATH=$PYTHONPATH:$NEWFIRM
