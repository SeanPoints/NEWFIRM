...
**Note: This program uses the same default.swarp configuration file used above.  Therefore, unless the file is changed, the stacked images will be 4200 x 4200 pixels.**
